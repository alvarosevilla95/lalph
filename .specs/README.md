...
- `github-parent-issue-selection.md`: Adds a GitHub-only project mode that watches the direct child issues of a bound parent issue and integrates with plan/issue flows.
